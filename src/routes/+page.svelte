<div class="pt-14 flex flex-col space-y-4">
  ...
  >
    <div
      class="absolute top-0 left-0 noise h-full w-full mix-blend-overlay opacity-5 dark:opacity-10 -z-10"
    />
    <div class="w-full flex flex-col items-center group">
      <div
        class="w-36 aspect-square rounded-full bg-zinc-500 group-hover:border-4 group-hover:border-rose-500"
      />
      <p class="small-caps tracking-wider font-medium">Electronics</p>
