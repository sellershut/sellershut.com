...
<button
  transition:fade
  on:click|self
  class="top-0 left-0 text-zinc-700 dark:text-zinc-200 absolute w-screen h-screen flex justify-center items-center bg-black/40 z-50 cursor-default backdrop-blur-sm"
>
  <div
    transition:fly
