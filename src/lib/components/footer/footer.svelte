        ...
        >
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav class="list-none mb-10 text-xs">
                    {#await $sliderCategories then categories}
                        {#each categories?.connection?.edges ?? [] as { node }}
                            {#if node}
                                <li>
                                    <a href={routePage(node.name)} class="hover:text-primary"
                                        >{node.name}</a
                                    >
                                </li>
                            {/if}
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav class="list-none mb-10">
                    <li>
                        <a href={"#"} class="text-xs">First Link</a>
                    </li>
                    <li>
                        <a href={"#"} class="text-xs">Second Link</a>
                    </li>
                    <li>
                        <a href={"#"} class="text-xs">Third Link</a>
                    </li>
                    <li>
                        <a href={"#"} class="text-xs">Fourth Link</a>
                    </li>
                </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
